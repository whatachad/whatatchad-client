    ...
    <S.ScheduleBox key={Schedule.scheduleId}>
      <S.ScheduleHeader>
        ...
        <S.ScheduleStatus>
          ...
          {Schedule.status ? (
            ...
            <HiOutlineBadgeCheck style={{ color: "#555555" }} />
          )}
        </S.ScheduleStatus>
      </S.ScheduleHeader>
      ...
      <S.AccountSection>
        {!addAccountIsOpen && (
          ...
          >
            <MdAccountBalanceWallet /> 가계부 추가
          </S.ListAddButton>
        )}
        {addAccountIsOpen && (
          <AddAccountForm setAddAccountIsOpen={setAddAccountIsOpen} />
        )}
      ...
      <S.DayWorkSection>
        ...
        {addDayWorkIsOpen && (
          <AddDayWorkForm setAddDayWorkIsOpen={setAddDayWorkIsOpen} />
        )}
